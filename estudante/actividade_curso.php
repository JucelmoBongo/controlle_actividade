...
$resul = $conectar->query("SELECT * FROM actividade_curso Join cursos ON actividade_curso.id_curso=cursos.id_curso Join estudante on cursos.id_curso=estudante.id_curso where id_estudante={$_SESSION['id_estudante']} ");
          ...
          <header>
               <nav>
                    <ul>
                         ...
                         <li><div class="li-div"><p class="p">Estudante(a)</p></div></li>
