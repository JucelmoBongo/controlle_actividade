...
// iniciando a session
session_start(); 
// se nao existir na variavel(array) de $session um dado nome_professor 
...
// bucando o total dos actividades 
$query_actividadeG = "SELECT COUNT(id_actividade_geral) AS total_actividadeG FROM actividade_geral";
$query_actividadeG = $conectar->prepare($query_actividadeG);
$query_actividadeG->execute();
$row_actividadeG = $query_actividadeG->fetch(PDO::FETCH_ASSOC);
...
<head>
    ...
    <title>Painel Professor - <?=$_SESSION['nome_professor']?></title>
</head>
<body>
          ...
          <header>
               <nav>
                    <ul>
                         ...
                         <li><div class="li-div"><p class="p" style="margin-left:10%">Professor(a)</p></div></li>
                         <li><a href="perfil.php" class="li-link"><i class="fas fa-user"></i><span class="nav-item">Perfil</span></a></li>
                         <li><a href="painel_professor.php" class="li-link"><i class="fas fa-home"></i><span class="nav-item">Home</span></a></li>
                         <li><a href="actividade_geral.php" class="li-link"><i class="fas fa-calendar-check"></i><span class="nav-item">Atividades Geral</span></a></li>
                         <li><a href="actividade_curso.php" class="li-link"><i class="fas fa-calendar-check"></i><span class="nav-item">Minhas Actidades</span></a></li>
                         <li><a href="#" class="li-link"><i class="fas fa-calendar-check"></i><span class="nav-item">Adicionar </span></a></li>
                         ...
                         <div class="dashbord-card" style="margin-bottom:24px">
                              ...
                              <div class="card">
                                   ...
                                   <aside class="card-aside">
                                       ...
                                       <?=$row_actividadeG['total_actividadeG']?>
                                        </p>
                                   </aside>
                         ...
                         <div class="dashbord-card">
                              ...
                              <div class="card-modal">
                                   <a href="actividade_curso.php" style="text-decoration:none"> 
                                        <button type="button" class="botao " id="btn-modal" >
                                             <i class="fas fa-plus-circle" id="fas"></i>
                                             <p class="card-aside-modal">Minhas Actividades</p>
                                        </button> 
                                   </a>
