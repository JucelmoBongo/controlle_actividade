...
*/ 
$resul = $conectar->query("SELECT * FROM estudante join cursos on estudante.id_curso=cursos.id_curso ");
...
<head>
    ...
    <title>Lista de Estudante</title>
    <!-- Bootstrap -->
                ...
                // nome do curso
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?=$row->nome_estudante?></td>
                            <td><?=$row->nome_curso?></td>
                            <td>
                                <a href="editar_curso.php?id=<?=$row->id_estudante?>" class="btn btn-info btn-lg btn-sm btn-xr color-white" title="Editar curso">editar</a>
                                <a href="apagar_curso.php?id=<?=$row->id_estudante?>" class="btn btn-danger btn-lg btn-sm btn-xr color-white" title="Apagar curso">Apagar</a>
                            </td>
                        </tr>
                       <?php
                    }
