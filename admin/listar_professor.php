...
*/ 
$resul = $conectar->query("SELECT * FROM professor join disciplina on professor.id_disciplina=disciplina.id_disciplina ");
                ...
                // nome do curso
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><?=$row->sexo?></td>
                            <td>
                                <a href="editar_professor.php?id=<?=$row->id_professor?>" class="btn btn-info btn-lg btn-sm btn-xr color-white" title="Editar curso">editar</a>
                                <a href="apagar_professor.php?id=<?=$row->id_professor?>" class="btn btn-danger btn-lg btn-sm btn-xr color-white" title="Apagar curso">Apagar</a>
                            </td>
                        </tr>
                       <?php
                    }
