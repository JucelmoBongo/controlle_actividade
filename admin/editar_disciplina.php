 ...
 try {
    if (isset($_POST['nome_disciplina'])) {
        $nome_disciplina= $_POST['nome_disciplina'];
         ...
         $conectar->query("UPDATE `disciplina` SET `nome_disciplina`='$nome_disciplina' WHERE id_disciplina = '$id'");
                  header("Location:listar_disciplina.php");
 
        }
       
   $dados_user = $conectar->query("SELECT * FROM disciplina WHERE id_disciplina ='$id'")->fetchObject();
 } catch (Exeption $e) {
   print_r($e);
 }
          ...
          <div class="mae">
               <div class="filho">
                    ...
                    <form action="#" enctype="multipart/form-data" method="post">
                         <input type="text" name="nome_disciplina" placeholder="Nome" required value="<?=$dados_user->nome_disciplina?>">
